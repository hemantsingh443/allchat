...
const ChatMessage = ({ 
    ...
    const customSyntaxStyle = { 'pre[class*="language-"]': { backgroundColor: 'rgba(20, 20, 22, 0.5)', backdropFilter: 'blur(4px)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '0.5rem', padding: '1rem', }, };
                ...
                {isEditing ? (
                    ...
                    <div className="group flex flex-col items-end">
                        ...
                        <GlassPanel className="p-1 rounded-br-none w-full">
                            {text && (
                                <div className="prose prose-sm prose-slate dark:prose-invert prose-p:my-2 prose-headings:my-3 max-w-none px-3 py-1 text-slate-700 dark:text-white">
                                    <ReactMarkdown
                                        children={text}
                                        components={{
